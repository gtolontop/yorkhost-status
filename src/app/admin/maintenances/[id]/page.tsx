      ...
      <div className="space-y-6 max-w-5xl mx-auto">
        ...
        >
          ...
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-10 top-0 bottom-0 w-0.5 bg-gray-200 dark:bg-gray-700"></div>
            ...
            <div className="space-y-0">
              ...
              >
                <div className="flex gap-4">
                  <div className="flex-shrink-0 relative z-10">
                    <div className="w-8 h-8 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center border-2 border-white dark:border-yorkhost-darkCard">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <p className="font-semibold text-gray-900 dark:text-white">Maintenance scheduled</p>
                        <p className="mt-1 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">{maintenance.description}</p>
                        {maintenance.creator && (
                          <div className="mt-3 flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                            <User size={12} />
                            <span>Created by {maintenance.creator.username}</span>
                          </div>
                        )}
                      </div>
                      <span className="text-xs text-gray-500 dark:text-gray-400 font-medium bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">
                        {formatTimestamp(maintenance.startTime)}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <AnimatePresence>
                {maintenance.updates?.map((update, index) => (
                  <motion.div
                    ...
                    className="relative p-6 py-4"
                  >
                    <div className="flex gap-4">
                      <div className="flex-shrink-0 relative z-10">
                        <div className={clsx(
                          'w-8 h-8 rounded-full flex items-center justify-center border-2 border-white dark:border-yorkhost-darkCard',
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <p className="mt-2 text-sm text-gray-700 dark:text-gray-300 leading-relaxed whitespace-pre-wrap">{update.message}</p>
                            {update.authorName && (
                              <div className="mt-3 flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                                <User size={12} />
                          ...
                          <span className="text-xs text-gray-500 dark:text-gray-400 font-medium bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded ml-4 flex-shrink-0">
              ...
              {(!maintenance.updates || maintenance.updates.length === 0) && (
                <div className="relative p-6 text-center">
                  <div className="absolute left-10 w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center border-2 border-white dark:border-yorkhost-darkCard z-10">
                    <Clock size={16} className="text-gray-400" />
                  </div>
                  <div className="ml-12">
                    <p className="text-sm text-gray-500 dark:text-gray-400">No updates yet</p>
                    <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Updates will appear here as the maintenance progresses</p>
                  </div>
                </div>
              )}
            </div>
        ...
        >
          <div
            className="px-6 py-4 border-b border-gray-200 dark:border-yorkhost-darkBorder cursor-pointer hover:bg-gray-50 dark:hover:bg-yorkhost-darkHover transition-colors group"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Post a new update about this maintenance</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                ...
                <div className="p-1 rounded-lg group-hover:bg-gray-200 dark:group-hover:bg-gray-700 transition-colors">
                  {showUpdateForm ? (
                ...
                <form onSubmit={handleSubmitUpdate} className="p-6 space-y-6">
                  <div>
                    ...
                    <div className="relative">
                      <textarea
                        ...
                        className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 resize-none transition-colors"
                        rows={4}
                        placeholder="Describe the maintenance progress, current status, or any important information..."
                        required
                      />
                      <div className="absolute bottom-3 right-3 text-xs text-gray-400 dark:text-gray-500">
                        {updateForm.message.length}/500
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      <div className="relative flex items-center">
                        <input
                          ...
                          className="w-5 h-5 text-blue-600 bg-white dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 rounded focus:ring-blue-500 dark:focus:ring-blue-400 focus:ring-2 transition-colors cursor-pointer"
                        />
                      </div>
                      <div className="flex-1">
                        <label htmlFor="changeStatus" className="text-sm font-semibold text-gray-700 dark:text-gray-300 cursor-pointer">
                          Change status with this update
                        </label>
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                          Automatically update the maintenance status when posting this update
                        </p>
                      </div>
                      {updateForm.changeStatus && (
                        <div className="flex items-center gap-2">
                          ...
                          <span className={clsx(
                            'px-2 py-1 text-xs font-medium rounded-full',
                            getStatusColor(updateForm.status)
                          )}>
                            {updateForm.status.replace(/_/g, ' ')}
                          </span>
                        </div>
                      )}
                    </div>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
                    <div className="text-xs text-gray-500 dark:text-gray-400">
                      Updates are posted immediately and will be visible to users
                    </div>
                    <div className="flex items-center gap-3">
                      <button
                        type="button"
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium shadow-sm"
                      >
                        {submitting ? (
                          <>
